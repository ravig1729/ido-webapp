                            ...
                            <div className="box-hover">
                                <div className="icon-list-flex">
                                    ...
                                    <div className="content">
                                        ...
                                        <a href="mailto:idoservice2@gmail.com" className="para1">idoservice2@gmail.com</a> <br />
                                        <a href="mailto:idoservice2@gmail.com"
                                            className="para1">idoservice2@gmail.com</a>
                                    </div>
                                </div>
                            </div>
                        </div>
