import causeLeftBg from '@/assets/img/breadcrumb/vl-cause-left-bg.png'
...
const Hero = () => {
    return (
        <section className="vl-breadcrumb" style={{backgroundImage: `url(${causeLeftBg})`}}>
