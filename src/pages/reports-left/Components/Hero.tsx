...
import eventDetails from '@/assets/img/breadcrumb/vl-event-details.png'
...
const Hero = () => {
    return (
        <section className="vl-breadcrumb" style={{ backgroundImage: `url(${eventDetails})` }}>
