...
// Define the structure for category content
...
export const categoryContent: Record<string, CategoryData> = {
        ...
        items: [
            {
                ...
                date: 'November 2024',
                author: 'IDO Team',
                summary: 'How IDO transformed reproductive health awareness in tribal communities through modern medical practices and education.',
                image: blogImg1,
                sections: [
                    {
                        paragraphs: [
            ...
            {
                id: 'adarsh-digital-education',
                title: 'Adarsh – Empowering Tribal Students with Digital Education',
                date: 'October 2024',
                author: 'IDO Team',
                summary: 'Recognition of Adarsh Vikas Sriram for his inspiring social initiative that brought digital learning to 450 tribal children.',
                image: blogImg2,
                sections: [
                    {
                        paragraphs: [
    ...
    "Case Studies": {
        items: [
            {
                id: 'anitha-emergency-delivery',
                title: 'Effective Application of Maternal Health Training by AAM Podiyam Sirisha in a Critical Emergency Delivery',
                date: 'August 2025',
                author: 'IDO Medical Team',
                summary: 'How CHW Sirisha\'s training helped save a mother and child during an emergency delivery in a remote tribal village.',
                image: caseStudyImg,
                sections: [
                    {
                        subtitle: 'Background:',
    ...
    "Interview": {
        items: [
            {
                id: 'unstoppable-show-recognition',
                title: 'IDO Receives Rs One Lakh Cash Prize on Unstoppable Show',
                date: 'September 2024',
                author: 'IDO Team',
    ...
    "Media": {
        items: [
            {
                id: 'media-coverage',
                title: 'Media Coverage and Press Releases',
                date: 'Various Dates',
                summary: 'Collection of media coverage showcasing IDO\'s impact in tribal communities.',
                sections: [
        ...
        items: [
            {
                ...
                title: 'Editorial Content Coming Soon',
                summary: 'Editorial articles and opinion pieces will be added here.',
                sections: [
                    {
                        paragraphs: ['Editorial content will be added soon.']
                    }
                ]
            }
        ]
    ...
    Opinion: {
        items: [
            {
                id: 'coming-soon-opinion',
                title: 'Opinion Pieces Coming Soon',
                summary: 'Expert opinions and thought leadership articles will be featured here.',
                sections: [
                    {
                        paragraphs: ['Opinion content will be added soon.']
                    }
                ]
            }
        ]
