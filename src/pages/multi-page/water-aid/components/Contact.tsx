                        ...
                        <div className="vl-contact-icon-box mb-30" data-aos="fade-right" data-aos-duration={1200}
                            ...
                            <div className="vl-icon-box-flex">
                                ...
                                <div className="vl-text">
                                    ...
                                    <a href="mailto:idoservice2@gmail.com" className="para">idoservice2@gmail.com</a> <br />
                                    <a href="mailto:idoservice2@gmail.com" className="para">idoservice2@gmail.com</a>
                                </div>
                            </div>
                        </div>
                    </Col>
