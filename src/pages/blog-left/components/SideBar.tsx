                ...
                <Row>
                    ...
                    <img src={searchIcon} alt='searchIcon'/>
                            ...
                            <div className="vl-phone-widget mb-30">
                                ...
                                <a href="#" className="phone"> <span><img src={phoneImg} alt='phoneImg'/></span>+123
                                    456 7890</a>
                            </div>
                        ...
                        <div className="vl-event-content-area ml-50">
                            ...
                            <div className="vl-event-content vl-blg-content">
                                ...
                                <p className="para pb-32">Whether you&#39;re learning about a new initiative,
                                    discovering
                                    how your donations are making an impact, or finding inspiration to get involved, our
                                    blog is here to connect.</p>
                            </div>
